...
/**
 * Template Name: design-catalogue
 */
get_header();
    ...
    <div class="hero-body">
        <div class="container is-max-desktop has-text-centered">
            ...
            <p class="title is-2 is-size-3-touch">
                <span class="has-text-red"> Design Catalogue </span>
            </p>
        </div>
    </div>
</section>
    ...
    <div class="columns">
        <div class="column">
            <p class="subtitle is-6 has-text-centered">
                In this section, we proudly feature the exceptional work of our students in various design fields.
            </p>
        </div>
    </div>
</div>
    ...
    ?>
        ...
        <div class="columns is-desktop is-multiline is-variable is-7">
            ...
            <div class="column has-text-item-centered">
                ...
                <a href="<?php the_field('link_to_flip-book') ?>" target="_blank">
